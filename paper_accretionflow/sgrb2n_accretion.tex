...
\FigureOneCol{figures/sgrb2n_sio_maser_and_hcn.pdf}
{SiO maser contours (blue) on HCN v3=1.
}
{fig:hcnandsio}{1}{3in}
...
% \section{SiO Maser in Sgr B2 N}
% We detect the SiO v=2 J=2-1 line as a maser with peak intensity $\sim0.43$ Jy \perbeam (9600 K).
